...
model WaterCooledChillerExample8 "Two 400 TR chillers with pump PID controller placeholders"
  ...
  parameter Modelica.SIunits.Power QChi_nominal = 400 * 3516.85284
    "Nominal cooling capacity of each chiller (400 refrigeration tons)";
  parameter Real kPumpPID = 0.1 "Initial pump PID gain; replace with final control tuning";
  parameter Modelica.SIunits.Time TiPumpPID = 120
    "Initial pump PID integral time; replace with final control tuning";
  ...
  Buildings.Controls.Continuous.LimPID conPumCHW(
    controllerType = Modelica.Blocks.Types.SimpleController.PI,
    k = kPumpPID, Ti = TiPumpPID, yMin = 0, yMax = 1.2 * mCHW_flow_nominal,
    initType = Modelica.Blocks.Types.InitPID.InitialOutput,
    y_start = mCHW_flow_nominal) "Placeholder flow PID for chiller 1 CHW pump" annotation(
    Placement(visible = true, transformation(origin = {196, 42}, extent = {{-10, -10}, {10, 10}})));
  Buildings.Controls.Continuous.LimPID conPumCW(
    controllerType = Modelica.Blocks.Types.SimpleController.PI,
    k = kPumpPID, Ti = TiPumpPID, yMin = 0, yMax = 1.2 * mCW_flow_nominal,
    initType = Modelica.Blocks.Types.InitPID.InitialOutput,
    y_start = mCW_flow_nominal) "Placeholder flow PID for chiller 1 CW pump" annotation(
    Placement(visible = true, transformation(origin = {330, 170}, extent = {{-10, -10}, {10, 10}})));
  Buildings.Controls.Continuous.LimPID conPumCHW2(
    controllerType = Modelica.Blocks.Types.SimpleController.PI,
    k = kPumpPID, Ti = TiPumpPID, yMin = 0, yMax = 1.2 * mCHW_flow_nominal,
    initType = Modelica.Blocks.Types.InitPID.InitialOutput,
    y_start = mCHW_flow_nominal) "Placeholder flow PID for chiller 2 CHW pump" annotation(
    Placement(visible = true, transformation(origin = {-42, 42}, extent = {{-10, -10}, {10, 10}})));
  Buildings.Controls.Continuous.LimPID conPumCW2(
    controllerType = Modelica.Blocks.Types.SimpleController.PI,
    k = kPumpPID, Ti = TiPumpPID, yMin = 0, yMax = 1.2 * mCW_flow_nominal,
    initType = Modelica.Blocks.Types.InitPID.InitialOutput,
    y_start = mCW_flow_nominal) "Placeholder flow PID for chiller 2 CW pump" annotation(
    Placement(visible = true, transformation(origin = {98, 170}, extent = {{-10, -10}, {10, 10}})));
equation
  ...
  connect(pumCWCon.y, conPumCW.u_s) annotation(
    Line(points = {{341, 199}, {312, 199}, {312, 170}, {318, 170}}, color = {0, 0, 127}));
  conPumCW.u_m = pumCW.m_flow;
  connect(conPumCW.y, pumCW.m_flow_in) annotation(
    Line(points = {{341, 170}, {350, 170}, {350, 200}, {356, 200}}, color = {0, 0, 127}));
  connect(pumCHWCon.y, conPumCHW.u_s) annotation(
    Line(points = {{183, 71}, {178, 71}, {178, 42}, {184, 42}}, color = {0, 0, 127}));
  conPumCHW.u_m = pumCHW.m_flow;
  connect(conPumCHW.y, pumCHW.m_flow_in) annotation(
    Line(points = {{207, 42}, {214, 42}, {214, 70}}, color = {0, 0, 127}));
  ...
  connect(pumCHWcon2.y, conPumCHW2.u_s) annotation(
    Line(points = {{-31, 69}, {-60, 69}, {-60, 42}, {-54, 42}}, color = {0, 0, 127}));
  conPumCHW2.u_m = pumCHW2.m_flow;
  connect(conPumCHW2.y, pumCHW2.m_flow_in) annotation(
    Line(points = {{-31, 42}, {-24, 42}, {-24, 70}}, color = {0, 0, 127}));
  ...
  connect(pumCWcon2.y, conPumCW2.u_s) annotation(
    Line(points = {{109, 199}, {80, 199}, {80, 170}, {86, 170}}, color = {0, 0, 127}));
  conPumCW2.u_m = pumCW2.m_flow;
  connect(conPumCW2.y, pumCW2.m_flow_in) annotation(
    Line(points = {{109, 170}, {116, 170}, {116, 200}}, color = {0, 0, 127}));
  ...
  connect(val8.port_b, junCHWSup.port_3);
  connect(pumCHW2.port_a, junCHWRet.port_3);
...
end WaterCooledChillerExample8;
