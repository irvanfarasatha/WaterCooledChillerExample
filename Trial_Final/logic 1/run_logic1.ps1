...
$ModelFile = Join-Path (Split-Path -Parent $ScriptDir) "logic1.mo"
$MosFile = Join-Path $ScriptDir "run_logic1.mos"
$LogFile = Join-Path $ScriptDir "openmodelica_run.log"
$RawPrefix = "logic1_raw"
$RawCsv = Join-Path $ScriptDir "$($RawPrefix)_res.csv"
$FinalCsv = Join-Path $ScriptDir "logic1_results.csv"
...
$Signals = @{
    ...
    chiller_1_mass_flow = @("TCHWChi1In.m_flow", "TCHWChi1Out.m_flow", "pumCHW.m_flow", "pumCHW.m_flow_actual", "chwPump1PID.mCHW_flow", "pumCHW.m_flow_in")
    chiller_2_mass_flow = @("TCHWChi2In.m_flow", "TCHWChi2Out.m_flow", "pumCHW2.m_flow", "pumCHW2.m_flow_actual", "chwPump2PID.mCHW_flow", "pumCHW2.m_flow_in")
