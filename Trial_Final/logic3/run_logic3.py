# coding: utf-8
"""Run logic3 with OpenModelica and export a clean analysis CSV.
...
MODEL_FILE = SCRIPT_DIR.parent / "logic3.mo"
MOS_FILE = SCRIPT_DIR / "run_logic3.mos"
LOG_FILE = SCRIPT_DIR / "openmodelica_run.log"
RAW_PREFIX = "logic3_raw"
RAW_CSV = SCRIPT_DIR / f"{RAW_PREFIX}_res.csv"
FINAL_CSV = SCRIPT_DIR / "logic3_results.csv"
...
OLD_VARIABLE_FILTER = (
    ...
    r"chi\.on|chi2\.on|chi\.P|chi2\.P|chi\.P.*|chi2\.P.*|chi\.TSet|chi2\.TSet|"
    r"chwstCtrl1\..*|chwstCtrl2\..*|"
...
SIGNALS = {
    ...
    "chiller_1_chwst_setpoint": ["chi.TSet", "combinedCtrl1.TCHWSTSet"],
    "chiller_2_chwst_setpoint": ["chi2.TSet", "combinedCtrl2.TCHWSTSet"],
    "chiller_1_request_more_chiller": ["combinedCtrl1.requestMoreChiller"],
    "chiller_2_request_more_chiller": ["combinedCtrl2.requestMoreChiller"],
}
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run logic3 with OpenModelica and export logic3_results.csv."
    )
    ...
    parser.add_argument(
        "--postprocess-only",
        action="store_true",
        help="Skip OpenModelica and rebuild logic3_results.csv from the raw CSV.",
    )
