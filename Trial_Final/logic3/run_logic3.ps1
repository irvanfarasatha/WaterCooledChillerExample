...
$ModelFile = Join-Path (Split-Path -Parent $ScriptDir) "logic3.mo"
$MosFile = Join-Path $ScriptDir "run_logic3.mos"
$LogFile = Join-Path $ScriptDir "openmodelica_run.log"
$RawPrefix = "logic3_raw"
$RawCsv = Join-Path $ScriptDir "$($RawPrefix)_res.csv"
$FinalCsv = Join-Path $ScriptDir "logic3_results.csv"
