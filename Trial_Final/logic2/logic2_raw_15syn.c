...
void logic2_raw_function_initSynchronous(DATA *data, threadData_t *threadData)
{
...
/* Update base-clock. */
void logic2_raw_function_updateSynchronous(DATA *data, threadData_t *threadData, long base_idx)
{
...
int logic2_raw_function_equationsSynchronous(DATA *data, threadData_t *threadData, long base_idx, long sub_idx)
{
  int ret;
...
/* %v% = pre(%v%)*/
void logic2_raw_function_savePreSynchronous(DATA *data, threadData_t *threadData)
{
}
