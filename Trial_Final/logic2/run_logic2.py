# coding: utf-8
"""Run logic2 with OpenModelica and export a clean analysis CSV.
...
MODEL_FILE = SCRIPT_DIR.parent / "logic2.mo"
MOS_FILE = SCRIPT_DIR / "run_logic2.mos"
LOG_FILE = SCRIPT_DIR / "openmodelica_run.log"
RAW_PREFIX = "logic2_raw"
RAW_CSV = SCRIPT_DIR / f"{RAW_PREFIX}_res.csv"
FINAL_CSV = SCRIPT_DIR / "logic2_results.csv"
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run logic2 with OpenModelica and export logic2_results.csv."
    )
    ...
    parser.add_argument(
        "--postprocess-only",
        action="store_true",
        help="Skip OpenModelica and rebuild logic2_results.csv from the raw CSV.",
    )
