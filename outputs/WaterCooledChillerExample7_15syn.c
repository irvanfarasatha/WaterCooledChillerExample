...
void outputs_WaterCooledChillerExample7_function_initSynchronous(DATA *data, threadData_t *threadData)
{
...
/* Update base-clock. */
void outputs_WaterCooledChillerExample7_function_updateSynchronous(DATA *data, threadData_t *threadData, long base_idx)
{
...
int outputs_WaterCooledChillerExample7_function_equationsSynchronous(DATA *data, threadData_t *threadData, long base_idx, long sub_idx)
{
  int ret;
...
/* %v% = pre(%v%)*/
void outputs_WaterCooledChillerExample7_function_savePreSynchronous(DATA *data, threadData_t *threadData)
{
}
