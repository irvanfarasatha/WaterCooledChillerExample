...
extern "C" {
#endif
int WaterCooledChillerExample_WaterCooledChillerExample7_mayer(DATA* data, modelica_real** res,short *i) {
...
int WaterCooledChillerExample_WaterCooledChillerExample7_lagrange(DATA* data, modelica_real** res, short * i1, short*i2) {
  throwStreamPrint(NULL, "The model was not compiled with -g=Optimica and the corresponding goal function. The optimization solver cannot be used.");
  return 0;
}
