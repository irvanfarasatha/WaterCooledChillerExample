...
void WaterCooledChillerExample_WaterCooledChillerExample7_function_initSample(DATA *data, threadData_t *threadData)
{
  long i=0;
}

const char *WaterCooledChillerExample_WaterCooledChillerExample7_zeroCrossingDescription(int i, int **out_EquationIndexes)
{
  ...
  static const int occurEqs0[] = {1,4519};
  static const int occurEqs1[] = {1,4519};
  static const int occurEqs2[] = {1,4401};
  static const int occurEqs3[] = {1,4419};
...
int WaterCooledChillerExample_WaterCooledChillerExample7_function_ZeroCrossingsEquations(DATA *data, threadData_t *threadData)
{
...
int WaterCooledChillerExample_WaterCooledChillerExample7_function_ZeroCrossings(DATA *data, threadData_t *threadData, double *gout)
{
...
const char *WaterCooledChillerExample_WaterCooledChillerExample7_relationDescription(int i)
{
...
int WaterCooledChillerExample_WaterCooledChillerExample7_function_updateRelations(DATA *data, threadData_t *threadData, int evalforZeroCross)
{
  const int *equationIndexes = NULL;
